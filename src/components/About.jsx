    ...
    return (
        <div className='about card'>
            ...
            <div className="card-body  d-flex justify-content-center">
                ...
                <div>
                    <p>Hello and welcome to my Portfolio page! My name is Alex Lenson, and I am an aspiring web devleoper. Here you can find my current projects, as well as future projects coming soon. These projects serve as a learning tool to help develop my skills in various web development technologies.</p>
